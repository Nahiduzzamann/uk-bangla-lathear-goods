                                    ...
                                    <div className="lg:w-1/2">
                                        <div className="grid grid-cols-2 sm:grid-cols-2 gap-4">
                                            <div className="flex justify-center">
                                                <img className="h-36 w-36 md:h-60 md:w-60 drop-shadow-2xl rounded-full shadow-2xl" src="https://www.jwoodleathers.co.uk/wp-content/uploads/2022/09/MOD_7290.jpg" alt="" />
                                            </div>
                                            <div>
                                                <img className="h-36 w-36 md:h-60 md:w-60 drop-shadow-2xl rounded-full shadow-2xl" src="https://i.shgcdn.com/ba27b086-ebd0-47d2-8f85-6f00662e17da/-/format/auto/-/preview/3000x3000/-/quality/lighter/" alt="" />
                                            </div>
                                            <div className="flex justify-center">
                                                <img className="h-36 w-36 md:h-60 md:w-60 drop-shadow-2xl rounded-full shadow-2xl" src="https://tandyleather.com/cdn/shop/products/a765a4de37b587309f2d4882cfbf7fb78f57afb0_1350x1350.jpg?v=1645724648" alt="" />
                                            </div>
                                            <div>
                                                <img className="h-36 w-36 md:h-60 md:w-60 drop-shadow-2xl rounded-full shadow-2xl" src="https://midlandsmeander.co.za/wp-content/uploads/4-3-scaled.jpg" alt="" />
                                            </div>
                                        </div>
                                    </div>
