  ...
  return (
    <div className="bg-[#493120] p-4 lg:p-10">
      ...
      <div className="flex flex-col items-center justify-center rounded-lg ">
        ...
        <p className="font-bold text-white text-3xl">Established In</p>
        <p className="text-2xl text-white">{establishedIn}</p>
      </div>
      ...
      <div className="flex flex-col items-center justify-center rounded-lg p-4">
        ...
        <p className="font-bold text-white text-3xl">Monthly Production Capacity</p>
        <p className="text-2xl text-white">{productionCapacity}</p>
      </div>
      ...
      <div className="flex flex-col items-center justify-center rounded-lg p-4">
        ...
        <p className="font-bold text-white text-3xl">Manufacturing Facility</p>
        <p className="text-2xl text-white">{manufacturingFacility} sq ft</p>
      </div>
    </div>
    </div>
  );
